 ...
 * @author Miguel
 */
public class InsertarAlojamiento extends javax.swing.JPanel {
    ...
    /**
     * Creates new form PanelDetallAlojamiento
     */
    public InsertarAlojamiento(MainScreen JFrameMainScreen) {
        initComponents();
...
//        txtNom.setText(alojamiento.getNom());
//        txtAdresa.setText(alojamiento.getAdresa());
//        txaDescripcio.setText(alojamiento.getDescripcio());
        initCmbMunicipis();
//        spnNumPersones.setValue(alojamiento.getNum_persones());
//        txtPreuNit.setText(Float.toString(alojamiento.getPreu_per_nit()));
//        initServeis();
    }
...
//        cmbMunicipi.setSelectedItem(alojamiento.getMunicipi());
    }

//    private void initServeis() {
//        var serveis = da.getServeisAlojamiento(alojamiento.getId());
...
//    }
    ...
    private void initComponents() {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(306, 42, 340, 80);
        ...
        add(jPanel1);
        jPanel1.setBounds(50, 280, 600, 100);
        ...
        add(btnInsert);
        btnInsert.setBounds(570, 400, 72, 23);
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        ...
        alojamiento.setNom(txtNom.getText());
        alojamiento.setAdresa(txtAdresa.getText());
        alojamiento.setMunicipi(cmbMunicipi.getSelectedItem().toString());
        alojamiento.setId_municipi(cmbMunicipi.getSelectedIndex()+1);
        alojamiento.setDescripcio(txaDescripcio.getText());
        try {
            spnNumPersones.commitEdit();
        } catch (java.text.ParseException e) {
            e.printStackTrace();
        }
        alojamiento.setNum_persones((Integer) spnNumPersones.getValue());
        alojamiento.setId_propietari(JFrameMainScreen.getAuthenticatedUser().getId());
        float preuPerNit = Float.parseFloat(txtPreuNit.getText());
        alojamiento.setPreu_per_nit(preuPerNit);
        int idNouAlojamiento = da.insertAlojamiento(alojamiento);
        
        if (idNouAlojamiento <= 0) {
            JOptionPane.showMessageDialog(JFrameMainScreen, "Error inserting new alojamiento.");
            return;
        }
        
        if (chkPiscina.isSelected()) {
            da.insertServei(1, idNouAlojamiento);
        }
        if (chkMascotes.isSelected()) {
            da.insertServei(2, idNouAlojamiento);
        }
        if (chkAireAcondicionat.isSelected()) {
            da.insertServei(3, idNouAlojamiento);
        }
        if (chkAscensor.isSelected()) {
            da.insertServei(4, idNouAlojamiento);
        }
        if (chkAparcament.isSelected()) {
            da.insertServei(5, idNouAlojamiento);
        }
        if (chkWifi.isSelected()) {
            da.insertServei(6, idNouAlojamiento);
        }
        
        JOptionPane.showMessageDialog(JFrameMainScreen, "Alojamiento inserted correctly.");
        
        JFrameMainScreen.reloadHomeScreen();
